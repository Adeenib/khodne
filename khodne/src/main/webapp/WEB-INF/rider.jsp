...
<body class="u-body">
	...
	<div class="map">
		<h3 style="dispaly: inline-block; width: 20%;">My Google Maps
			Demo</h3>
		...
		<div class="u-clearfix u-sheet u-sheet-1">
			...
			<div class="u-form u-form-1">
				<form action="#" method="POST"
					...
					<p id="profile" onmouseover="showForm();" onmouseout="hideForm();">
						<h4 class="u-text u-text-2">Edit Profile</h4><span id="profileForm">
							<div class="u-form-address u-form-group u-form-group-1">
								<label for="address-c3e7" class="u-label u-label-1">Name</label>
								<input type="text" placeholder="Enter your name"
									id="address-c3e7" name="address"
							...
							<div class="u-form-email u-form-group">
								...
								<input type="email" placeholder="Enter a valid email address"
									id="email-8c36" name="email"
									class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white u-input-2"
									required="">
							</div>
							<div class="u-form-group u-form-phone u-form-group-3">
								<label for="phone-347e" class="u-label u-label-3">Phone
									Number</label> <input type="tel"
									pattern="\+?\d{0,3}[\s\(\-]?([0-9]{2,3})[\s\)\-]?([\s\-]?)([0-9]{3})[\s\-]?([0-9]{2})[\s\-]?([0-9]{2})"
									placeholder="Enter your phone (e.g. +14155552675)"
									id="phone-347e" name="phone"
									class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white u-input-3"
									required="">
							</div>
							<div
								class="u-form-address u-form-group u-hidden-sm u-form-group-4">
								<label for="address-cae9"
									class="u-form-control-hidden u-label u-label-4"></label> <input
									type="text" placeholder="Enter your address" id="address-cae9"
									name="address-1"
									class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white u-input-4"
									required="">
							</div>
							<div class="u-align-left u-form-group u-form-submit">
								<a href="#" class="u-btn u-btn-submit u-button-style">Save!</a>
			...
			<a href="https://nicepage.com/k/love-html-templates"
				class="u-active-none u-border-none u-btn u-button-style u-hover-none u-none u-text-palette-3-base u-btn-1">Request
				a <span style="font-weight: 700;"></span>Trip&nbsp;
			</a>
				...
				<form action="#" method="POST"
					...
					<div class="u-form-group u-form-name">
						...
						<input type="text" placeholder="Enter Your Current Location"
							id="name-ad01" name="name"
							class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white u-input-5"
							required="">
					</div>
					<div class="u-form-email u-form-group">
						<label for="email-ad01" class="u-label u-label-6">Passengers
							Number</label> <input type="email" placeholder="Enter Passengers Number"
							id="email-ad01" name="email"
					...
					<div class="u-form-group u-form-group-8">
						...
						<input type="text" id="text-d63a" name="text"
			...
			<div class="u-expanded-width u-table u-table-responsive u-table-1">
				<table class="u-table-entity">
					<colgroup>
						...
						<col width="35.49999999999999%">
					</colgroup>
					<thead class="u-black u-table-header u-table-header-1">
						<tr style="height: 21px;">
							<th class="u-border-1 u-border-black u-table-cell">Driver
								Name</th>
							...
							<th class="u-border-1 u-border-black u-table-cell">Phone
								Number&nbsp;</th>
						</tr>
					</thead>
